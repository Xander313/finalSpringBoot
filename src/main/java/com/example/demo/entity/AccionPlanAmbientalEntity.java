...
public class AccionPlanAmbientalEntity {
    ...
    private SeccionPlanAmbientalEntity seccionPlanAmbiental;
    ...
    public SeccionPlanAmbientalEntity getSeccionPlanAmbiental() {
        return seccionPlanAmbiental;
    }

    public void setSeccionPlanAmbiental(SeccionPlanAmbientalEntity seccionPlanAmbiental) {
