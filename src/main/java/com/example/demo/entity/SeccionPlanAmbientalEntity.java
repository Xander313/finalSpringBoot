...
public class SeccionPlanAmbientalEntity {
    ...
    private List<AccionPlanAmbientalEntity> acciones;
    ...
    public List<AccionPlanAmbientalEntity> getAcciones() {
        return acciones;
    }

    public void setAcciones(List<AccionPlanAmbientalEntity> acciones) {
